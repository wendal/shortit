...
<script type="text/javascript">
	function init(){
	  document.getElementById('shortA').href = "javascript:function shortUrl() {var d = document, b = d.body, l = d.location;try {if (!l||!b) {return;}var divId = 'nutz_shortit';" + 
	  		...
	  		"div.setAttribute('style', 'z-index:99999999;background-color:#FFFFC0;position:fixed;left:10px;top:10px;'+ 'width:188px;height:120px;border:3px solid #FFA54F;');}"+
